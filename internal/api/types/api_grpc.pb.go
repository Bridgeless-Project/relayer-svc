...
const (
	...
	API_GetWithdrawalsByStatus_FullMethodName = "/api.API/GetWithdrawalsByStatus"
...
type APIClient interface {
	...
	GetWithdrawalsByStatus(ctx context.Context, in *GetWithdrawalsByStatusRequest, opts ...grpc.CallOption) (*GetWithdrawalsByStatusResponse, error)
...
func (c *aPIClient) GetWithdrawalsByStatus(ctx context.Context, in *GetWithdrawalsByStatusRequest, opts ...grpc.CallOption) (*GetWithdrawalsByStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetWithdrawalsByStatusResponse)
	err := c.cc.Invoke(ctx, API_GetWithdrawalsByStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) CheckHealth(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, API_CheckHealth_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type APIServer interface {
	...
	GetWithdrawalsByStatus(context.Context, *GetWithdrawalsByStatusRequest) (*GetWithdrawalsByStatusResponse, error)
...
func (UnimplementedAPIServer) GetWithdrawalsByStatus(context.Context, *GetWithdrawalsByStatusRequest) (*GetWithdrawalsByStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetWithdrawalsByStatus not implemented")
}
...
func _API_GetWithdrawalsByStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetWithdrawalsByStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).GetWithdrawalsByStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: API_GetWithdrawalsByStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).GetWithdrawalsByStatus(ctx, req.(*GetWithdrawalsByStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _API_CheckHealth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).CheckHealth(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var API_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetWithdrawalsByStatus",
			Handler:    _API_GetWithdrawalsByStatus_Handler,
		},
		{
