...
func (x *WithdrawalIdentifier) GetOperator() string {
	if x != nil {
		return x.Operator
	}
	return ""
...
type TransferData struct {
	...
	MerkleProof   string  `protobuf:"bytes,11,opt,name=merkle_proof,json=merkleProof,proto3" json:"merkle_proof,omitempty"`
	TxData        string  `protobuf:"bytes,12,opt,name=tx_data,json=txData,proto3" json:"tx_data,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TransferData) GetMerkleProof() string {
	if x != nil {
...
func (x *TransferData) GetTxData() string {
	if x != nil {
		return x.TxData
	}
	return ""
...
const file_deposit_proto_rawDesc = "" +
	...
	"\bchain_id\x18\x03 \x01(\tR\achainId\"\xa0\x02\n" +
	...
	"\x16withdrawal_chain_block\x18\x04 \x01(\x03H\x02R\x14withdrawalChainBlock\x88\x01\x01\x12\x1a\n" +
	"\boperator\x18\x05 \x01(\tR\boperatorB\n" +
	"\n" +
	"\b_tx_hashB\x18\n" +
	"\x16_withdrawal_core_blockB\x19\n" +
	"\x17_withdrawal_chain_block\"\xdf\x03\n" +
	...
	"\tsignature\x18\n" +
	" \x01(\tH\x01R\tsignature\x88\x01\x01\x12!\n" +
	"\fmerkle_proof\x18\v \x01(\tR\vmerkleProof\x12\x17\n" +
