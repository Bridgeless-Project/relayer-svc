...
type Client interface {
	...
	WithdrawNative(depositData db.Deposit) (txHash string, err error)
	WithdrawToken(depositData db.Deposit) (txHash string, err error)
	WithdrawWrapped(depositData db.Deposit) (txHash string, err error)
}
